...
import static com.frank.halo.model.support.HaloConst.HALO_VERSION;
...
public class SwaggerConfiguration {
    ...
    public Docket haloDefaultApi() {
        ...
        return buildApiDocket("com.frank.halo.content.api",
                "com.frank.halo.controller.content.api",
                "/api/content/**")
    ...
    public Docket haloAdminApi() {
        ...
        return buildApiDocket("com.frank.halo.admin",
                "com.frank.halo.controller.admin",
                "/api/admin/**")
