...
import com.frank.halo.controller.support.PageJacksonSerializer;
import com.frank.halo.factory.StringToEnumConverterFactory;
import com.frank.halo.model.support.HaloConst;
import com.frank.halo.security.resolver.AuthenticationArgumentResolver;
...
import static com.frank.halo.model.support.HaloConst.HALO_ADMIN_RELATIVE_PATH;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.frank.halo.controller")
